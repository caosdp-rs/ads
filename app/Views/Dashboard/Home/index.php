                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="product-thumb">
                                        <img width="80px" height="auto" src="<?php echo site_url('web/'); ?>images/products/products-1.jpg" alt="image description">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="product-thumb">
                                        <img width="80px" height="auto" src="<?php echo site_url('web/'); ?>images/products/products-2.jpg" alt="image description">
                                    </td>
                                    <td class="product-details">
                                ...
                                <tr>
                                    ...
                                    <td class="product-thumb">
                                        <img width="80px" height="auto" src="<?php echo site_url('web/'); ?>images/products/products-3.jpg" alt="image description">
                                    </td>
                                    <td class="product-details">
                                        <h3 class="title">Macbook Pro 15inch</h3>
                                        <span class="add-id"><strong>Ad ID:</strong> ng3D5hAMHPajQrM</span>
                                ...
                                <tr>
                                    ...
                                    <td class="product-thumb">
                                        <img width="80px" height="auto" src="<?php echo site_url('web/'); ?>images/products/products-4.jpg" alt="image description">
                                    </td>
                                    <td class="product-details">
                                        <h3 class="title">Macbook Pro 15inch</h3>
                                        <span class="add-id"><strong>Ad ID:</strong> ng3D5hAMHPajQrM</span>
